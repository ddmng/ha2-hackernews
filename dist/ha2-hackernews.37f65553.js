...
},{}],"local_modules/hyperapp-fx/src/fx/Console.js":[function(require,module,exports) {
"use strict";
...
},{}],"local_modules/hyperapp-fx/src/fx/Random.js":[function(require,module,exports) {
"use strict";
...
},{}],"local_modules/hyperapp-fx/src/utils.js":[function(require,module,exports) {
"use strict";
...
},{}],"local_modules/hyperapp-fx/src/fx/Http.js":[function(require,module,exports) {
"use strict";
...
},{"../utils.js":"local_modules/hyperapp-fx/src/utils.js"}],"local_modules/hyperapp-fx/src/fx/BatchFx.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.BatchFx = BatchFx;
...
},{}],"local_modules/hyperapp-fx/src/fx/Merge.js":[function(require,module,exports) {
"use strict";
...
function mergeEffect(props, dispatch) {
  dispatch(function (state) {
    return (0, _utils.assign)(state, props.action(state));
  });
}
...
},{"../utils.js":"local_modules/hyperapp-fx/src/utils.js"}],"local_modules/hyperapp-fx/src/fx/Debounce.js":[function(require,module,exports) {
"use strict";
...
function Debounce(props) {
  return (0, _utils.assign)({ effect: debounceEffect }, props);
}
},{"../utils.js":"local_modules/hyperapp-fx/src/utils.js"}],"local_modules/hyperapp-fx/src/fx/Throttle.js":[function(require,module,exports) {
"use strict";
...
function Throttle(props) {
  return (0, _utils.assign)({ effect: throttleEffect }, props);
}
},{"../utils.js":"local_modules/hyperapp-fx/src/utils.js"}],"local_modules/hyperapp-fx/src/fx/index.js":[function(require,module,exports) {
"use strict";
...
var _BatchFx = require("./BatchFx.js");

Object.keys(_BatchFx).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
...
},{"./Console.js":"local_modules/hyperapp-fx/src/fx/Console.js","./Random.js":"local_modules/hyperapp-fx/src/fx/Random.js","./Http.js":"local_modules/hyperapp-fx/src/fx/Http.js","./BatchFx.js":"local_modules/hyperapp-fx/src/fx/BatchFx.js","./Merge.js":"local_modules/hyperapp-fx/src/fx/Merge.js","./Debounce.js":"local_modules/hyperapp-fx/src/fx/Debounce.js","./Throttle.js":"local_modules/hyperapp-fx/src/fx/Throttle.js"}],"local_modules/hyperapp-fx/src/subs/Time.js":[function(require,module,exports) {
"use strict";
...
function Time(props) {
  return (0, _utils.assign)(props, {
    effect: timeEffect
  });
}
},{"../utils.js":"local_modules/hyperapp-fx/src/utils.js"}],"local_modules/hyperapp-fx/src/subs/Animation.js":[function(require,module,exports) {
"use strict";
...
},{}],"local_modules/hyperapp-fx/src/subs/Keyboard.js":[function(require,module,exports) {
"use strict";
...
function keyboardEffect(sub, dispatch) {
  var removeListenerForEvent = _utils.makeRemoveListener.bind(null, document, dispatch, sub.action);
...
},{"../utils.js":"local_modules/hyperapp-fx/src/utils.js"}],"local_modules/hyperapp-fx/src/subs/WebSocketClient.js":[function(require,module,exports) {
"use strict";
...
function webSocketEffect(sub, dispatch) {
  ...
  var removeListen;
  if (sub.listen) {
    removeListen = (0, _utils.makeRemoveListener)(connection.socket, dispatch, sub.listen, "message");
    connection.listeners.push(removeListen);
  }
  var removeError;
  if (sub.error) {
    removeError = (0, _utils.makeRemoveListener)(connection.socket, dispatch, sub.error, "error");
...
},{"../utils.js":"local_modules/hyperapp-fx/src/utils.js"}],"local_modules/hyperapp-fx/src/subs/index.js":[function(require,module,exports) {
"use strict";
...
var _WebSocketClient = require("./WebSocketClient.js");
...
},{"./Time.js":"local_modules/hyperapp-fx/src/subs/Time.js","./Animation.js":"local_modules/hyperapp-fx/src/subs/Animation.js","./Keyboard.js":"local_modules/hyperapp-fx/src/subs/Keyboard.js","./WebSocketClient.js":"local_modules/hyperapp-fx/src/subs/WebSocketClient.js"}],"local_modules/hyperapp-fx/src/index.js":[function(require,module,exports) {
"use strict";
...
var _index = require("./fx/index.js");
...
var _index2 = require("./subs/index.js");
...
},{"./fx/index.js":"local_modules/hyperapp-fx/src/fx/index.js","./subs/index.js":"local_modules/hyperapp-fx/src/subs/index.js"}],"utils/utils.js":[function(require,module,exports) {
"use strict";
...
},{}],"navbuttons.js":[function(require,module,exports) {
"use strict";
...
},{"./hyperapp/hav2":"hyperapp/hav2.js"}],"navs.js":[function(require,module,exports) {
'use strict';
...
var _index2 = require('./local_modules/hyperapp-fx/src/index');

var fx = _interopRequireWildcard(_index2);
...
var view = exports.view = function view(_ref) {
  var state = _ref.state,
      onSetList = _ref.onSetList,
      onFetchStories = _ref.onFetchStories;
  return (0, _index.h)(
    'div',
    { 'class': 'lists' },
    (0, _index.h)(navbutton.list, { state: state, title: 'New stories', tag: 'new', text: 'New', onSelect: onSetList }),
    (0, _index.h)(navbutton.list, { state: state, title: 'Top trending stories', tag: 'top', text: 'Top', onSelect: onSetList }),
    (0, _index.h)(navbutton.list, { state: state, title: 'Best stories', tag: 'best', text: 'Best', onSelect: onSetList }),
    (0, _index.h)(navbutton.list, { state: state, title: 'Ask HackerNews', tag: 'ask', text: 'AskHN', onSelect: onSetList }),
    (0, _index.h)(navbutton.list, { state: state, title: 'Show HackerNews', tag: 'show', text: 'ShowHN', onSelect: onSetList }),
    (0, _index.h)(navbutton.list, { state: state, title: 'Jobs list', tag: 'job', text: 'Jobs', onSelect: onSetList }),
    (0, _index.h)(navbutton.refresh, { state: state, onRefresh: onFetchStories })
  );
};
},{"./local_modules/hyperapp/src/index":"local_modules/hyperapp/src/index.js","./local_modules/hyperapp-fx/src/index":"local_modules/hyperapp-fx/src/index.js","./navbuttons":"navbuttons.js"}],"utils/squirrel.js":[function(require,module,exports) {
'use strict';
...
exports.default = function (map) {
  ...
  var view = function view(_ref2) {
    ...
    return (0, _index.h)(
      "div",
      { "class": "bookmark", onClick: [Bookmark, { id: id }] },
      (0, _index.h)("i", { "class": icon(state, id) })
    );
  };

  return { initial: initial, view: view };
};
},{"./local_modules/hyperapp/src/index":"local_modules/hyperapp/src/index.js"}],"article.js":[function(require,module,exports) {
'use strict';
  ...
  if (item[1].fetched) {
    return (0, _index.h)(
      ...
      (0, _index.h)(
        'div',
        null,
        (0, _index.h)('i', { 'class': icon(item[1].type, item[1].url) })
      ),
      (0, _index.h)(
        'div',
        null,
...
},{"./local_modules/hyperapp/src/index":"local_modules/hyperapp/src/index.js","./local_modules/hyperapp-fx/src/index":"local_modules/hyperapp-fx/src/index.js","./utils/squirrel":"utils/squirrel.js","./bookmark":"bookmark.js"}],"../../../.nvm/versions/node/v8.11.3/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var navs = _interopRequireWildcard(_navs);
...
var FetchArticles = function FetchArticles(state) {
  return [_extends({}, state, {
    ...
    fetching: true
  }), fx.BatchFx.apply(fx, _toConsumableArray(Object.keys(state.articles).map(function (item) {
    return fx.Http({
  ...
  view: function view(state) {
    return (0, _index.h)(
      ...
      (0, _index.h)(
        'nav',
        null,
        (0, _index.h)(navs.view, { state: state, onSetList: SetList, onFetchStories: FetchStories })
      ),
      (0, _index.h)(
        'div',
        null,
...
},{"./local_modules/hyperapp/src/index":"local_modules/hyperapp/src/index.js","./local_modules/hyperapp-fx/src/index":"local_modules/hyperapp-fx/src/index.js","./utils/utils":"utils/utils.js","./navs":"navs.js","./article":"article.js","./styles/style.css":"styles/style.css"}],"../../../.nvm/versions/node/v8.11.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/ha2-hackernews.37f65553.map